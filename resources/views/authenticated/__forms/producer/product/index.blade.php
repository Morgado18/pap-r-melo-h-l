    ...
    <div class="form-row align-items-center">
        <div class="row">
            <div class="col-md-6">
                ...
                @enderror
                <input type="text" class="form-control mb-2" placeholder="Nome" required name="product_name"
            ...
            <div class="col-md-6">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" placeholder="Preço" required name="product_price"
                        value="{{ old('product_price', isset($product) ? $product->price : '') }}">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @error('product_quant_stock')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                <input type="number" class="form-control mb-2" placeholder="Quant. em Stock" required name="product_quant_stock"
                    value="{{ old('product_quant_stock', isset($product) ? $product->quantity : '') }}">
            </div>
            ...
            <div class="col-md-6">
                ...
                @error('product_quant_min_buy')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                <input type="number" class="form-control mb-2" placeholder="Quant. min para compra" required
                    name="product_quant_min_buy"
                    value="{{ old('product_quant_min_buy', isset($product) ? $product->min_quant_to_buy : '') }}">
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="sel1" required name="product_status">
                        ...
                        @foreach ($data['product_status'] as $product_status)
                            @if($product_status->status != "Pendente")
                            <option value="{{ $product_status->id }}" {{ isset($product) ? ($product->product_status_id == $product_status->id) ? "selected" : "" : ""}}>
                                {{ $product_status->status }}</option>
                            @endif
                        @endforeach
                    </select>
                </div>
        ...
        <div class="col-md-12">
            ...
            <div class="input-group mb-3">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input form-control" required multiple name="product_img[]" {{ isset($product) ? "disabled" : "" }}>
