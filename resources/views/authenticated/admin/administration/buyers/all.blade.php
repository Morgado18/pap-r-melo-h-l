...
@section('pageTitle', 'Todos os Compradores')
...
@section('currentPage', 'Todos Compradores')
                            ...
                            <div class="col-md-6">
                                <form action="" method="get" class="">
                                    <input type="search" name="search"
                                        ...
                                        placeholder="Pesquisar comprador" class="form-control" {{ ($data['users']->isEmpty()) ? "disabled" : "" }}>
                                </form>
                            </div>
                            <div class="col-md-6">
                                <form action="" class="">
                                        ...
                                        <center>
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.administration.buyers.remove', ['id' => $user->user_id]) }}">Remover</a>
                                            </div>
                                        </center>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog modal-l" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Mais informações do Comprador</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <p>
                                                            <strong>Edereço padrão:</strong> <br>
                                ...
                                <div class="modal fade" id="modalEdit{{ $user->id }}">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                @include('authenticated.admin.administration.buyers.edit.index')
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="modalCreate">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cadastrar Comprador</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                @include('authenticated.admin.administration.buyers.create.index')
            </div>
        </div>
    </div>
</div>
...
@session("success")
    ...
    <script>
        Swal.fire({
            title: 'Comprador {{ session('success') }} com sucesso!',
            icon: 'success',
            width: 400,
            heightAuto: false,
...
@session("updated")
    ...
    <script>
        Swal.fire({
            title: 'Comprador {{ session('updated') }} com sucesso!',
            icon: 'success',
            width: 400,
            heightAuto: false,
            showConfirmButton: false,
...
@session("removed")
    ...
    <script>
        Swal.fire({
            title: 'Comprador {{ session('removed') }} com sucesso!',
            icon: 'success',
            width: 400,
            heightAuto: false,
            showConfirmButton: false,
