...
@section('pageTitle', 'Produtos Disponível')

@section('currentPageTitle')

    Listando Todos os Produtos Disponível

@endsection


@section('currentPage', 'Produtos Disponível')
    ...
    {{-- <div class="modal fade" id="modalCreate">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('authenticated.admin.products.create.index')
                </div>
            </div>
        </div>
    </div> --}}
